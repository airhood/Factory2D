...
public class CollisionChecker {
	...
	public void checkTile(Entity entity, Direction[] movingDirections, int estimatedWorldX, int estimatedWorldY) {
		int entityLeftWorldX = (entity.worldX * (-1)) + entity.solidArea.x;
		int entityRightWorldX = (entity.worldX * (-1)) + entity.solidArea.x + entity.solidArea.width;
		int entityTopWorldY = (entity.worldY * (-1)) + entity.solidArea.y;
		int entityBottomWorldY = (entity.worldY * (-1)) + entity.solidArea.y + entity.solidArea.height;
			...
			try {
				switch(movingDirections[0]) {
					case up:
						...
						tileNum1 = gamePanel.tileManager.mapTileNum[i][entityLeftCol][entityTopRow];
						tileNum2 = gamePanel.tileManager.mapTileNum[i][entityRightCol][entityTopRow];
					...
					case down:
						...
						tileNum1 = gamePanel.tileManager.mapTileNum[i][entityLeftCol][entityBottomRow];
						tileNum2 = gamePanel.tileManager.mapTileNum[i][entityRightCol][entityBottomRow];
					...
					case left:
						...
						tileNum1 = gamePanel.tileManager.mapTileNum[i][entityLeftCol][entityTopRow];
						tileNum2 = gamePanel.tileManager.mapTileNum[i][entityLeftCol][entityBottomRow];
					...
					case right:
						...
						tileNum1 = gamePanel.tileManager.mapTileNum[i][entityRightCol][entityTopRow];
						tileNum2 = gamePanel.tileManager.mapTileNum[i][entityRightCol][entityBottomRow];
				...
				if (doubleCollision) {
					if (twoTouch[0] && !twoTouch[1]) {
						...
						entity.collisionOnDirections[0] = movingDirections[0];
						entity.collisionOnDirections[1] = movingDirections[1];
					}
				} else {
					if (!twoTouch[0]) {
